...
created: 2023-05-31T15:07:00.000+02:00
...
First, I downloaded flags in _png_ format for each country ([from this site](https://flagpedia.net/download)) and put them in one folder. Next I wrote a python script that loops over this folder and calculated color statistics for each of them. Results are saved in the JSON file.
